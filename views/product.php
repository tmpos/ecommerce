      ...
      <?php if ($product['stock'] > 0): ?>
        ...
        <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
          ...
          <div class="flex gap-2">
            ...
            <a href="https://www.facebook.com/sharer/sharer.php?u=<?= urlencode($shareUrl) ?>" target="_blank" class="w-9 h-9 rounded-full bg-blue-600 text-white flex items-center justify-center hover:bg-blue-700 transition" title="Facebook">
